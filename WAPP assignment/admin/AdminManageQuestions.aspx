<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminManageQuestions.aspx.cs" Inherits="WAPP_assignment.admin.AdminManageQuestions" %>
    ...
    <div class="dashboard">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="AdminManageQuestions.aspx" class="sidebar-link active">
                     <svg class="sidebar-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <main class="main-content">
            <header class="dashboard-header">
                <div>
                    <h1 class="dashboard-title">Manage All Questions</h1>
                    <p class="dashboard-subtitle">View and remove questions from any quiz.</p>
                </div>
            </header>

            <section class="users-section" id="questions">
                <div class="users-table">
                    <table>
                            ...
                            <asp:Repeater ID="rptQuestions" runat="server" OnItemCommand="rptQuestions_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="user-info">
                                                <div class="user-avatar-small"><%# GetAvatarInitial(Eval("TeacherName")) %></div>
                                                <div>
                                                    <div class="user-name"><%# Eval("TeacherName") %></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-danger btn-sm"
                                                ...
                                                OnClientClick="return confirm('Are you sure you want to permanently delete this question?');">
                                                Delete
                                            </asp:LinkButton>
                                        </td>
                                    </tr>
                     ...
                     <asp:Panel ID="pnlNoQuestions" runat="server" Visible="false" Style="text-align: center; padding: 20px;">
                        <p>There are no questions in the system yet.</p>
                    </asp:Panel>
                </div>
            </section>
        </main>
